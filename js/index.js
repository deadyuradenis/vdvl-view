  ...
  var mount = function mount() {
    ...
    if (document.querySelector('[data-component="header-nav"]')) {
      ...
      var check = function check() {
        ...
        if (component.offsetWidth < sourceList.offsetWidth) {
          hide();
        } else if (dropdownLast && component.offsetWidth >= Number(sourceList.offsetWidth + dropdownLast.offsetWidth + 40)) {
          show();
        }
...
;// CONCATENATED MODULE: ./src/core/ui/input/input/index.js
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { _defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
function _defineProperty(obj, key, value) { key = _toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var validate = function validate(element) {
  ...
  switch (mask) {
    ...
    case 'card-number':
      var regexpCardNumber = /^\d{4}\s\d{4}\s\d{4}\s\d{4}$/;
      return regexpCardNumber.test(input.value);
    case 'card-cvv':
      var regexpCVV = /^[0-9]{3,4}$/;
      return regexpCVV.test(input.value);
    case 'card-date':
      var regexpCardDate = /^(0[1-9]|1[0-2]) \/ (0[1-9]|[12][0-9]|3[01])$/;
      return regexpCardDate.test(input.value);
    case 'sale':
      var regexpSale = /^([1-9]?[0-9])\s?%$/;
      return regexpSale.test(input.value);
    case 'inn':
      var regexpInn = /^[0-9]{12}$/;
      return regexpInn.test(input.value);
    case 'kpp':
      var regexpKpp = /^[0-9]{9}$/;
      return regexpKpp.test(input.value);
    case 'ogrn':
      var regexpOgrn = /^[0-9]{13}$/;
      return regexpOgrn.test(input.value);
    case 'ogrnip':
      var regexpOgrnip = /^[0-9]{15}$/;
      return regexpOgrnip.test(input.value);
    case 'price':
...
var check = function check(element) {
  ...
  if (required) {
    ...
    if (result) {
      input_status.add(element, 'success');
      input_status.remove(element, 'error');
    } else {
      input_status.add(element, 'error');
      input_status.remove(element, 'success');
    }
  }
  if (input.value !== '') {
    input_status.add(element, 'filled');
  } else {
    input_status.remove(element, 'filled');
  }
};
...
var init = function init(element) {
  ...
  input.addEventListener('blur', function () {
    input_status.remove(element, 'focused');
    check(element);
  });
  input.addEventListener('focus', function () {
    ...
    input_status.remove(element, 'filled');
    input_status.remove(element, 'success');
    input_status.add(element, 'focused');
  });
};
(function (window) {
  var mount = function mount() {
...
;// CONCATENATED MODULE: ./node_modules/scrollbooster/src/index.js
...
;// CONCATENATED MODULE: ./src/core/ui/drag-scroll/index.js
function drag_scroll_typeof(obj) { "@babel/helpers - typeof"; return drag_scroll_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, drag_scroll_typeof(obj); }
function drag_scroll_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function drag_scroll_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? drag_scroll_ownKeys(Object(source), !0).forEach(function (key) { drag_scroll_defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : drag_scroll_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
function drag_scroll_defineProperty(obj, key, value) { key = drag_scroll_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function drag_scroll_toPropertyKey(arg) { var key = drag_scroll_toPrimitive(arg, "string"); return drag_scroll_typeof(key) === "symbol" ? key : String(key); }
function drag_scroll_toPrimitive(input, hint) { if (drag_scroll_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (drag_scroll_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
...
(function (window) {
  ...
  window.app.components = drag_scroll_objectSpread(drag_scroll_objectSpread({}, window.app.components), {}, {
    'drag-scroll': {
      init: build
    }
  });
...
(function (window) {
  ...
  var build = function build(element) {
    ...
    window.app.sliders = slider_objectSpread(slider_objectSpread({}, window.app.sliders), {}, slider_defineProperty({}, sliderId, slider));
  };
  var mount = function mount() {
    window.app.sliders = {};
  ...
  window.app.components = slider_objectSpread(slider_objectSpread({}, window.app.components), {}, {
    'slider': {
      init: build
    }
  });
...
;// CONCATENATED MODULE: ./src/core/modules/modals/index.js
function modals_typeof(obj) { "@babel/helpers - typeof"; return modals_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, modals_typeof(obj); }
function modals_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function modals_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? modals_ownKeys(Object(source), !0).forEach(function (key) { modals_defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : modals_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
...
function modals_toPropertyKey(arg) { var key = modals_toPrimitive(arg, "string"); return modals_typeof(key) === "symbol" ? key : String(key); }
function modals_toPrimitive(input, hint) { if (modals_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (modals_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }

(function (window) {
  var init = function init(element) {
    var elementModal = new Modal(element);
  ...
  var build = function build(element) {
    ...
    window.app.modals = modals_objectSpread(modals_objectSpread({}, window.app.modals), {}, modals_defineProperty({}, id, elementModal));
  };
  var mount = function mount() {
    var elements = Array.from(document.querySelectorAll('.modal'));
    elements.forEach(build);
  };
  window.app.modals = modals_objectSpread(modals_objectSpread({}, window.app.modals), {}, {
    init: build
  });
  document.addEventListener('DOMContentLoaded', mount);
})(window);
